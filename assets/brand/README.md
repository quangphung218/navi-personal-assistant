...
The earlier `navi-mark.svg` and `navi-app-icon.svg` were removed because their silhouettes did not match the selected concept. They remain recoverable in Git history. This PNG is not a vector or transparent-background asset; a future SVG must be visually compared against the approved reference before replacing it.
